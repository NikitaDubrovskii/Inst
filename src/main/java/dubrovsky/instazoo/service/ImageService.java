...
import dubrovsky.instazoo.entity.ImageModel;
import dubrovsky.instazoo.entity.Post;
import dubrovsky.instazoo.entity.UserModel;
import dubrovsky.instazoo.exceptions.ImageNotFoundException;
import dubrovsky.instazoo.repository.ImageRepository;
...
public class ImageService {
    ...
    private <T>Collector<T, ?, T> toSignPostCollector() {
